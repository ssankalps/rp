...
class ObjectDetectionClient(fl.client.NumPyClient):
    """A Flower client for YOLOv5-based object detection optimized for Raspberry Pi with local training."""

    def __init__(self, rtsp_url, frames_to_capture, train_frames, cid, resolution=(320, 240), headless=False, epochs=1, skip_training=False):
